...
public abstract class TeleLib extends OpMode {
    ...
    public void init() {
        ...
        leftElbow = hardwareMap.servo.get("LElbow");
        rightHookArm = hardwareMap.servo.get("RArm");
        leftHookArm = hardwareMap.servo.get("LArm");
    ...
    public void output() {
        ...
        if (gamepad1.right_trigger > .5) {
            if (rightHookArm.getPosition() == 1) {
                rightHookArm.setPosition(0);
            } else if (rightHookArm.getPosition() == 0) {
                rightHookArm.setPosition(1);
            }

        } else if (gamepad1.left_trigger > .5) {
            if (leftHookArm.getPosition() == 1) {
                leftHookArm.setPosition(0);
            } else if (leftHookArm.getPosition() == 0) {
                leftHookArm.setPosition(1);
            }

        } else if (gamepad1.dpad_right) {
            if (rightElbow.getPosition() == 1) {
                rightElbow.setPosition(0);
            } else if (rightElbow.getPosition() == 0) {
                rightElbow.setPosition(1);
            }

        }else if (gamepad1.dpad_left) {
            if (leftElbow.getPosition() == 1) {
